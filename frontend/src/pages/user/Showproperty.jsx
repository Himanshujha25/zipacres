    ...
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <div className="md:hidden mb-6">
        <button
          ...
          className="w-full px-6 py-3 bg-gradient-to-tr from-blue-950 to-blue-900 text-white text-md font-semibold rounded-lg shadow hover:scale-105 hover:from-blue-900  hover:to-blue-950 transition flex items-center justify-center gap-2"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      <div
        className={`
          ...
          ${isSearchOpen ? "flex flex-col gap-4 fixed inset-x-4 top-4 z-50 max-h-screen overflow-y-auto" : "hidden md:flex"}
        `}
      >
        {/* Mobile: Close button */}
      ...
      {loading ? (
        <div className="flex justify-center items-center py-20">
          {/* Tailwind spinner */}
          <div className="h-10 w-10 border-4 border-blue-800 border-t-transparent rounded-full animate-spin"></div>
          <span className="ml-3 text-blue-900 font-medium">Loading properties…</span>
        </div>
