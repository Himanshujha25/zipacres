...
export default function Contact() {
  ...
  const initialForm = {
    ...
    email: "",
    phone: "",
    subject: location.state?.propertyTitle ? `Inquiry about ${location.state.propertyTitle}` : "",
                ...
                {({ isSubmitting }) => (
                  <Form className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        <Field name="name" placeholder="Enter name" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all" />
                        <ErrorMessage name="name" component="p" className="text-red-600 text-sm mt-1" />
                      </div>
                      <div>
                        <Field name="phone" placeholder="+91 987xxxxxx" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all" />
                        <ErrorMessage name="phone" component="p" className="text-red-600 text-sm mt-1" />
                      </div>
                    </div>

                    <div>
                      <Field name="email" type="email" placeholder="Your@email.com" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all" />
                      <ErrorMessage name="email" component="p" className="text-red-600 text-sm mt-1" />
                    </div>

                    <div>
                      <Field as="select" name="subject" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all">
                      ...
                      <ErrorMessage name="subject" component="p" className="text-red-600 text-sm mt-1" />
                    </div>

                    <div>
                      <Field as="textarea" name="message" rows="5" placeholder="Please describe your requirements..." className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all resize-none" />
                      <ErrorMessage name="message" component="p" className="text-red-600 text-sm mt-1" />
                    </div>

                    <button type="submit" disabled={isSubmitting} className="w-full bg-gray-700 text-white font-medium py-3 px-6 rounded-lg hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors">
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6">
                ...
                >
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600">+91 9876xxxx</p>
                  </div>
                </a>
                <a
