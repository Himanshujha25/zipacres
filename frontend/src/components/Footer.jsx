      ...
      >
          ...
          <motion.div variants={fadeInUp}>
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex items-center text-gray-400">
                <PhoneIcon />
                <span className="ml-3">+91 xxxxxxxx</span>
              </div>
              <div className="flex items-center text-gray-400">
                <MailIcon />
            ...
            <div className="flex space-x-4">
              ...
              <SocialIcon href="https://youtube.com" label="YouTube"><YouTubeIcon /></SocialIcon>
            </div>
          </motion.div>
        ...
        <motion.div variants={fadeInUp} className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">© {new Date().getFullYear()} ZipAcres Real Estate. All Rights Reserved.</p>
            <button
