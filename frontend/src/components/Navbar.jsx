            ...
            <div className="ml-4 flex items-center space-x-2">
              {!user ? (
                <>
                  <Link
                    to="/login"
                    className="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-blue-900"
                  >
                    Log In
                  </Link>
                  <Link
                ...
                {!user ? (
                  <>
                    <Link
                      to="/login"
                      onClick={() => setMobileMenuOpen(false)}
                      className="block text-center rounded-md bg-gray-700 px-3 py-2 text-base font-medium text-white hover:bg-blue-900"
                    >
                      Log In
                    </Link>
                    <Link
                      to="/signup"
                      onClick={() => setMobileMenuOpen(false)}
                      className="block text-center rounded-md bg-blue-900 px-3 py-2 text-base font-medium text-white hover:bg-blue-800"
                    >
                      Sign Up
                    </Link>
                  </>
